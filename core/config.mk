...
ifneq ($(FLAMINGO_BUILD),)
include vendor/flamingo/target/board/BoardConfigFlamingo.mk
endif
...
ifneq ($(FLAMINGO_BUILD),)
ifneq ($(wildcard device/flamingo/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/flamingo/sepolicy/common/sepolicy.mk)
endif
endif
